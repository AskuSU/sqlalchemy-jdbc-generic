...
def _jdbc_connect_jpype(jclassname, url, driver_args, jars, libs, *args, **kwargs):
    ...
    if not jpype.isJVMStarted():
        ...
        if class_path:
            args.append("-Djava.class.path=%s" % osp.pathsep.join(class_path))
        if libs:
        ...
        jvmpath = kwargs.get("_jvmpath", jpype.getDefaultJVMPath())
        ...
        if jaydebeapi_ext.old_jpype:
            ...
            jpype.startJVM(jvmpath, *args, ignoreUnrecognized=True, convertStrings=True)
